...
namespace Carbon_Field_Brightcove;
...
class Video_Field extends Field {
	...
	public static function field_type_activated() {
		$dir = \Carbon_Field_Brightcove\DIR . '/languages/';
		$locale = get_locale();
		$path = $dir . $locale . '.mo';
		load_textdomain( 'carbon-field-brightcove', $path );
	}
	...
	public static function admin_enqueue_scripts() {
		$root_uri = \Carbon_Fields\Carbon_Fields::directory_to_url( \Carbon_Field_Brightcove\DIR );

		// Enqueue field styles.
		wp_enqueue_style(
			'carbon-field-brightcove',
